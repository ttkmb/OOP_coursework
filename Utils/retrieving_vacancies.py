...
def hh_vacancies(skill_name, count_vacancies):
    ...
    for item in vacancies:
        ...
        salary = item['salary']['from'] if item['salary'] and 'from' in item['salary'] else 'Не указана'
        ...
        vacancy = Vacancy(vacancy_name, url, salary, salary_currency, description, experience)
